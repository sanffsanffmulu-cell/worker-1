  ...
  Widget _buildCategoryCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: cyanLight.withOpacity(0.3), width: 1),
        boxShadow: [
          BoxShadow(
      ...
      child: Column(
        ...
        children: [
          // Category Header dengan gradien biru
          Container(
            ...
            child: Row(
              children: [
                Icon(icon, color: softWhite, size: 20),
        ...
        children: [
          ...
          if (onCopy != null)
            Container(
              ...
              child: IconButton(
                icon: Icon(copyIcon, color: cyanLight, size: 18),
                onPressed: onCopy,
